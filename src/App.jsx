        ...
        <form onSubmit={handleSubmit} className="register-form">
          {isRegistering && (
            <>
			  ...
			  <div className="form-group"><label>Country of Origin</label><input type="text" value={formData.country} onChange={e => setFormData({...formData, country: e.target.value})} placeholder="e.g. Japan" /></div>
