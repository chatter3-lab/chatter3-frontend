    ...
    <div className="auth-container">
      <div className="auth-box" style={{position:'relative'}}>
        ...
        <div className="google-button-container">
          <button type="button" onClick={()=>{window.location.href=`https://accounts.google.com/o/oauth2/v2/auth?client_id=${GOOGLE_CLIENT_ID}&redirect_uri=${encodeURIComponent(window.location.origin)}/&response_type=code&scope=email%20profile&prompt=select_account`;}} style={{display:'flex',alignItems:'center',justifyContent:'center',gap:10,width:'100%',padding:'10px 16px',border:'1px solid #dadce0',borderRadius:8,background:'white',cursor:'pointer',fontSize:'.9rem',fontWeight:500,color:'#3c4043',fontFamily:'inherit'}}>
