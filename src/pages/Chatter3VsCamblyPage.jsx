...
export default function Chatter3VsCamblyPage({lang='en'}){
  ...
  const faqSchema={
    ...
    "@type":"FAQPage",
    "mainEntity":[
      {"@type":"Question","name":t.chatter3VsCambly.faq1Question,"acceptedAnswer":{"@type":"Answer","text":t.chatter3VsCambly.faq1Answer}},
      {"@type":"Question","name":t.chatter3VsCambly.faq2Question,"acceptedAnswer":{"@type":"Answer","text":t.chatter3VsCambly.faq2Answer}},
      {"@type":"Question","name":t.chatter3VsCambly.faq3Question,"acceptedAnswer":{"@type":"Answer","text":t.chatter3VsCambly.faq3Answer}},
      {"@type":"Question","name":t.chatter3VsCambly.faq4Question,"acceptedAnswer":{"@type":"Answer","text":t.chatter3VsCambly.faq4Answer}}
    ]
  };
  const breadcrumbSchema={
    ...
    "itemListElement":[
      ...
      {"@type":"ListItem","position":2,"name":"Chatter3 vs Cambly","item":"https://app.chatter3.com/chatter3-vs-cambly"}
    ]
  };
  return(
    <div className="lp">
