  ...
  if(editing)return(
    <div className="admin-section">
      ...
      <div style={{display:'flex',flexDirection:'column',gap:'.75rem'}}>
        ...
        <div><label style={{fontSize:'.82rem',color:'#9ca3af'}}>{t.admin.blog.content} <span style={{fontSize:'.72rem'}}>({t.admin.blog.contentHelp})</span></label><RichEditor key={editing} value={form.content} onChange={val=>setForm(f=>({...f,content:val}))}/></div>
